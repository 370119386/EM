#ifndef __EM__MAP__H__
#define __EM__MAP__H__
...
{
public:
    typedef std::map<T, TD*> EMMapOBJECT;
    ...
    {
        typename EMMapOBJECT::iterator itr = mObjectList.find(name);
        if (itr == mObjectList.end())
        {
            mObjectList.insert(typename EMMapOBJECT::value_type(name, data));
            return true;
        }
...
private:
    EMMapOBJECT     mObjectList;
    typename EMMapOBJECT::iterator mObjectCurIter;
};
